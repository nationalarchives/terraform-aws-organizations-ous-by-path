...
variable "organization_id" {
  description = "The ID of the AWS Organization. If not provided, the module will attempt to discover it using a data source."
  type        = string
  default     = null
}

variable "organization_root_id" {
  description = "The Root ID of the AWS Organization. If not provided, the module will attempt to discover it using a data source."
  type        = string
  default     = null
}
